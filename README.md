...
CREES can be accessed using a [Google Sheets Addon](https://chrome.google.com/webstore/detail/crisis-event-extraction-s/jekdamaeeejebcccbgleijlfamjcbilc?utm_source=permalink). The add-on can be connected to any public CREES endpoint.

More information about the add-on as well as its source code is [available](addon/README.md).
